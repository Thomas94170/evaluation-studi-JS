...
document.querySelector('.btn-play').addEventListener('click', function() {
    if(debutJeu) {
        ...
        document.querySelector(".imageD").setAttribute("src", images[nombreAleatoire]);
        ...
        if (nombreAleatoire !== 1) {
            ...
            document.querySelector('#temporaire-' + adversaire).textContent = roundScore;
        } else {
...
document.querySelector('.btn-hold').addEventListener('click', function() {
    if (debutJeu) {
        ...
        document.querySelector('#score-' + adversaire).textContent = score[adversaire];
